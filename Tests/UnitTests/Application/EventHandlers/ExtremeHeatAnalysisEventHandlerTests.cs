...
namespace Tests.UnitTests.Application.EventHandlers
{
    public class ExtremeHeatAnalysisEventHandlerTests
    {
        ...
        private readonly global::Application.Configuration.ExtremeHeatSettings _settings;
        ...
        public ExtremeHeatAnalysisEventHandlerTests()
        {
            ...
            _settings = new global::Application.Configuration.ExtremeHeatSettings { Threshold = 40 };
        ...
        {
            // Arrange
            var measurement = new FieldMeasurement(1, 50, 45, 10, DateTime.UtcNow); // 45°C > 40°C threshold
        ...
        {
            // Arrange
            var measurement = new FieldMeasurement(1, 50, 35, 10, DateTime.UtcNow); // 35°C < 40°C threshold
            var measurementEvent = new MeasurementCreatedEvent(measurement);
